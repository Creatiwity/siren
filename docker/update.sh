...
print_usage() {
    echo "update - update Sirene data"
    echo " "
    echo "update LOG_LEVEL SIRENE_ENV POSTGRES_USER POSTGRES_PASSWORD POSTGRES_DB DOCKER_UID DOCKER_GID DOCKER_USER"
    echo " "
    echo "options:"
...
docker-compose run sirene ./sirene update all
