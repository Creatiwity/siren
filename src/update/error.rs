...
custom_error! { pub Error
    ...
    MissingContentLengthHeader = "Needed header 'Content-Length' is missing while downloading",
    ...
    MissingAcceptRangesHeader = "Needed header 'Accept-Ranges' is missing while downloading",
    InvalidAcceptRangesHeader {head_error: reqwest::header::ToStrError} = "Needed header 'Accept-Ranges' is invalid while downloading ({head_error})",
